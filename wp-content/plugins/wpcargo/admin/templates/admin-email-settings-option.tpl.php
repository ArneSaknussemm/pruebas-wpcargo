<form method="post" action="options.php" class="email-setting-admin-form" style="display: block;overflow: hidden;clear: both;">
	...
	<div id="form-fields-wrapper" class="three-fourths">
		<table class="form-table">
			<tbody>
				<tr>
					<th scope="row"><?php esc_html_e('Activate Admin Email Notification?', 'wpcargo'); ?></th>
					<td><input type="checkbox" name="wpcargo_admin_mail_active" <?php checked( $wpcargo_admin_mail_active, 1); ?> value="1">
						<p class="description"><?php esc_html_e('Please check if you want to send email after updating the shipment.','wpcargo'); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e('Select Shipment Status to send email Notification', 'wpcargo'); ?></th>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" placeholder="info@wpcargo.com" name="wpcargo_admin_mail_domain" value="<?php echo $wpcargo_admin_mail_domain; ?>" >
						<p class="description"><?php esc_html_e('Edit this if you want to change the header of your email automation. Default will be','wpcargo'); ?> <?php echo get_option('admin_email'); ?></p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="wpcargo_admin_mail_subject" value="<?php echo $wpcargo_admin_mail_subject; ?>">
						<p class="description"><?php esc_html_e('Email Subject','wpcargo'); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e('Message Content:','wpcargo'); ?></th>
					<td>
						<textarea cols="40" rows="12" placeholder='<p>Dear Admin,</p>
					<p>Shipment number {wpcargo_tracking_number} has been updated to {status}.</p>
					<br />
					<p>Yours sincerely</p>
					<p><a href="{site_url}">{site_name}</a></p>' name='wpcargo_admin_mail_body'><?php echo $wpcargo_admin_mail_body; ?></textarea>
					</td>
				</tr>
				<tr>
